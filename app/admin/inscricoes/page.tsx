        ...
        {loading ? (
          ...
          return (
            <div
              ...
              onClick={() => router.push(`/admin/inscritos/${inscrito.id}`)}
            >
              <div>
              ...
              <button
                onClick={(e) => { e.stopPropagation(); const limpo = inscrito.telefone.replace(/\D/g, ''); window.location.href = `https://wa.me/55${limpo}` }}
